...
fastlane supply --track 'production' --json_key_data "$DELIVER_JSON_KEY" --package_name "org.js.onefx.android" --apk "app.apk" --skip_upload_metadata --skip_upload_images --skip_upload_screenshots
